...
3. 能聽懂和閱讀國語和書寫中文或英文。能閱讀英文參考書。TOEFL PBT (托福紙筆考試) 成績達 530 分（閱讀成績 58 分以上），或托福 TOEFL iBT（托福網路考試）成績達 72 分（閱讀成績 22 分以上）（本院代碼：3133）; 或 IELTS (雅思) 成績達 6 分(閱讀成績 6.5 分以上) ; 或通過CWTS英文面試。於英語教學之學院取得學士或碩士學位者，可免除此項要求。
...
10. 近期托福或雅思成績單\*\*（非必要, 但申請人須具備基本英文閱讀能力）可透過以下方式之一證明：
    - TOEFL PBT (托福紙筆考試) 成績達 530 分（閱讀成績 58 分以上），或托福 TOEFL iBT（托福網路考試）成績達 72 分（閱讀成績 22 分以上）（本院代碼：3133）。
    - IELTS 雅思成績達 6 分(閱讀成績6.5分以上)
    - 曾於英語授課之學院取得學士學位
    - 通過 CWTS 英文面試
