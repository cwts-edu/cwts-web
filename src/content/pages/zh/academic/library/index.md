...
## 圖書館概況與資源介紹
自設立以來，本院圖書館館藏已增至 43,000 餘冊中英文書籍。
<form method="get" action="https://cwts.bywatersolutions.com/cgi-bin/koha/opac-search.pl">
   <input type="text" name="q" placeholder="輸入關鍵詞...">
   <input type="submit" value="查詢基神圖書館館藏">
</form>
